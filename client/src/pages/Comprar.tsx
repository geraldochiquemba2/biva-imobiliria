...
export default function Comprar() {
  const [filters, setFilters] = useState<SearchPropertyParams>({ type: 'Vender' });
  ...
  const handleSearch = () => {
    const newFilters: SearchPropertyParams = { type: 'Vender' };
        ...
        <Card className="max-w-5xl mx-auto p-8 shadow-2xl">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
            <div className="text-sm text-muted-foreground">
              Pesquise entre milhares de imóveis para comprar
            </div>
