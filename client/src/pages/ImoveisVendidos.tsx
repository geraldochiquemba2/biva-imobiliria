...
export default function ImoveisVendidos() {
  ...
  const soldProperties = userProperties.filter(p => p.status === 'vendido');
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto">
              {soldProperties.length} {soldProperties.length === 1 ? 'imóvel vendido' : 'imóveis vendidos'}
            </p>
          </motion.div>
        </div>
      </section>
          ...
          {soldProperties.length === 0 ? (
            <Card className="relative overflow-hidden">
              ...
              <CardContent className="text-center py-16 relative z-10">
                <Home className="h-16 w-16 mx-auto mb-4 text-purple-600" />
                <h3 className="text-2xl font-bold mb-2">
                  Nenhum imóvel vendido
                </h3>
                <p className="text-muted-foreground">
                  Você não possui imóveis vendidos no momento
                </p>
              </CardContent>
            </Card>
          ) : (
                    ...
                    <div className="flex-1 py-4 pr-4">
                      <div className="flex items-start justify-between gap-4 mb-4">
                        ...
                        <div className="flex gap-2">
                          <Badge className="bg-purple-600" data-testid={`badge-status-${property.id}`}>Vendido</Badge>
