        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto">
              {availableProperties.length} {availableProperties.length === 1 ? 'imóvel disponível' : 'imóveis disponíveis'} para arrendar ou vender
            </p>
          </motion.div>
        </div>
      </section>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            <Link href="/imoveis-disponiveis">
              <Card className="relative overflow-hidden hover-elevate active-elevate-2 cursor-pointer border-2 border-green-500">
                <div 
              ...
              <Card className="relative overflow-hidden hover-elevate active-elevate-2 cursor-pointer">
                ...
                <CardContent className="relative z-10">
                  <div className="text-2xl font-bold text-blue-600">
                    {propertiesLoading ? '...' : userProperties.filter(p => p.status === 'arrendado').length}
                  </div>
                </CardContent>
              </Card>
            </Link>
              ...
              <Card className="relative overflow-hidden hover-elevate active-elevate-2 cursor-pointer">
                ...
                <CardContent className="relative z-10">
                  <div className="text-2xl font-bold text-purple-600">
                    {propertiesLoading ? '...' : userProperties.filter(p => p.status === 'vendido').length}
                  </div>
                </CardContent>
              </Card>
            </Link>
              ...
              <Card className="relative overflow-hidden hover-elevate active-elevate-2 cursor-pointer">
                ...
                <CardContent className="relative z-10">
                  <div className="text-2xl font-bold text-gray-600">
                    {propertiesLoading ? '...' : userProperties.filter(p => p.status === 'indisponivel').length}
                  </div>
                </CardContent>
              </Card>
            </Link>
            ...
            <Card className="relative overflow-hidden">
              ...
              <CardContent className="text-center py-16 relative z-10">
                ...
                <p className="text-muted-foreground">
                  Todos os seus imóveis estão arrendados, vendidos ou indisponíveis
                </p>
              </CardContent>
            </Card>
          ) : (
