            ...
            <Card className="relative overflow-hidden">
              ...
              <CardContent className="text-center py-16 relative z-10">
                ...
                <h3 className="text-2xl font-bold mb-2">
                  Nenhum imóvel arrendado
                </h3>
                <p className="text-muted-foreground">
                  Você não possui imóveis arrendados no momento
                </p>
              </CardContent>
            </Card>
          ) : (
                    ...
                    <div className="flex-1 py-4 pr-4">
                      <div className="flex items-start justify-between gap-4 mb-4">
                        ...
                        <div className="flex gap-2">
                          <Badge className="bg-blue-600" data-testid={`badge-status-${property.id}`}>Arrendado</Badge>
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                              <DropdownMenuItem disabled data-testid={`action-edit-${property.id}`}>
