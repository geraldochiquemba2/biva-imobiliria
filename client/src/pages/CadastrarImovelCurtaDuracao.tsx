...
const propertyFormSchema = z.object({
  ...
  category: z.enum(['Apartamento', 'Casa'], {
...
export default function CadastrarImovelCurtaDuracao() {
    ...
    >
      ...
      <div className="max-w-3xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-2xl">Publicar Imóvel de Curta Duração</CardTitle>
              <CardDescription>
                Cadastre seu imóvel para arrendamento temporário (hospedagem, férias, estadias curtas)
              </CardDescription>
            </CardHeader>
            <CardContent>
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-4 rounded-md bg-blue-50 dark:bg-blue-950 border border-blue-200 dark:border-blue-800">
                    <p className="text-sm text-blue-900 dark:text-blue-100">
                      <strong>Arrendamento de Curta Duração:</strong> Este imóvel será publicado como arrendamento temporário (hospedagem, férias, etc.). Não será possível criar contratos formais para imóveis de curta duração.
                    </p>
                  </div>
